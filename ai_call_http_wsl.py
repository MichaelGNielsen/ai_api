...
# Ollama bruger port 11434 og har et indfødt endpoint på /api/chat
...
data = {
    ...
    "stream": False  # Vi vil have hele svaret på én gang
}
...
try:
    ...
    # Print modellens svar (Ollama format: response['message']['content'])
